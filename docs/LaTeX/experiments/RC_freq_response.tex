...
\chapter{Basic RC Circuits - High-pass and Low-pass Filters}
...
f_c = \frac{1}{2\pi R C}.
\]
The attenuation/gain is measured in terms of the unit decibel (dB), where gain in dB is defined as follows:
...
\begin{figure}[htbp]
	...
	\begin{subfigure}{0.45\linewidth}
		...
		\label{fig:rc-hpf}
	\end{subfigure}
	\caption{First order RC filter circuits}
	\label{fig:firstOrderRCCkts}
\end{figure}
\section{Procedure}
