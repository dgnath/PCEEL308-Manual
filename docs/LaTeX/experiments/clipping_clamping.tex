...
\begin{figure}[htbp]
	...
	\begin{subfigure}{0.52\textwidth}
		...
		\begin{circuitikz}[american, scale=0.75, line width=0.8pt]
			...
			\draw (0,0) node[ground]{};
			\node[below=0.3cm, align=center] at (Res1.center)  {$1\ k\Omega$};
		\end{circuitikz}
...
\begin{enumerate}[label=\arabic*.]
	\item Assemble the shunt positive clipper of Figure~\ref{fig:ShuntPosClipperCkt} on the breadboard. Set the function generator to a sine wave of frequency $100\,\text{Hz}$ and amplitude $10\,\text{V}_{pp}$. 
