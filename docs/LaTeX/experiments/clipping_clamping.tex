...
\begin{notebox}
	While preparing the lab-report, circuit diagrams shall contain proper labels for the components, including the component part numbers (such as 1N4001), and values/parameters (example: $5\ V_{pp}$, Sine, 50 Hz, for the source; $R_1$, $50\ \text{k}\Omega$, etc.).
\end{notebox}	
