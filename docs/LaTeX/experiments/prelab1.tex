...
\end{figure}
\begin{notebox}
	Modern DSOs have advanced measurement features that enable direct reading of the phase difference between two waveforms on screen, using cursor measurements. For more details, consult the operating manual of the DSO model. 
\end{notebox}
