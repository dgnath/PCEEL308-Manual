...
\begin{enumerate}
	\item Connect the circuit as shown in Figure~\ref{fig:zener-regulator} with $R_L$ set to give $I_L = I_{L(\max)} = 5\ \text{mA}$ (i.e., $R_L = V_Z / I_{L(\max)} \approx 1.12\ \text{k}\Omega$).
