...
% ============================================================
\input{./experiments/prelab1}
\input{./experiments/prelab2}
\input{./experiments/clipping_clamping}
\input{./experiments/zener_regulator}
\input{./experiments/RC_freq_response}
\end{document}
